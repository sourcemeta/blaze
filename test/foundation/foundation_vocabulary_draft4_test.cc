...
TEST(Foundation_vocabulary_draft4, parse_vocabularies_without_vocabulary) {
...
TEST(Foundation_vocabulary_draft4, parse_vocabularies_with_vocabulary) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "$vocabulary": {
      "https://json-schema.org/draft/2020-12/vocab/core": true
...
TEST(Foundation_vocabulary_draft4, schema) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "type": "object"
  })JSON");
...
TEST(Foundation_vocabulary_draft4, hyperschema) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
...
TEST(Foundation_vocabulary_draft4, one_hop) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
...
TEST(Foundation_vocabulary_draft4, ignore_vocabulary) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
