...
TEST(AlterSchema_lint_draft4, valid_examples_7) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "examples": [ { "foo": 1 } ],
    "properties": {
...
TEST(AlterSchema_lint_draft4, valid_default_7) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "default": { "foo": 1 },
    "properties": {
...
TEST(AlterSchema_lint_draft4, exclusive_bounds_false_drop_1) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "type": "integer",
    "minimum": 0,
...
TEST(AlterSchema_lint_draft4, exclusive_bounds_false_drop_2) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "type": "integer",
    "maximum": 100,
...
TEST(AlterSchema_lint_draft4, exclusive_bounds_false_drop_3) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "type": "number",
    "minimum": 0,
...
TEST(AlterSchema_lint_draft4, exclusive_bounds_false_drop_4) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "type": "integer",
    "minimum": 0,
...
TEST(AlterSchema_lint_draft4, exclusive_bounds_false_drop_5) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "type": "integer",
    "minimum": 0,
...
TEST(AlterSchema_lint_draft4, unknown_format_prefix_recognized) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "type": "object",
    "properties": {
...
TEST(AlterSchema_lint_draft4, unknown_format_prefix_demote_host_name) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "type": "string",
    "format": "host-name"
...
TEST(AlterSchema_lint_draft4, unknown_format_prefix_demote_ip_address) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "type": "string",
    "format": "ip-address"
...
TEST(AlterSchema_lint_draft4, unknown_format_prefix_demote_color) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "type": "string",
    "format": "color"
...
TEST(AlterSchema_lint_draft4,
     unknown_format_prefix_demote_temporarily_removed_date) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "type": "string",
    "format": "date"
...
TEST(AlterSchema_lint_draft4, unknown_format_prefix_collision_iterates) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "type": "string",
    "format": "color",
...
TEST(AlterSchema_lint_draft4, unknown_format_prefix_collision_iterates_twice) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "type": "string",
    "format": "color",
...
TEST(AlterSchema_lint_draft4, unknown_format_prefix_non_string_left_unchanged) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "type": "string",
    "format": 42
...
TEST(AlterSchema_lint_draft4, unknown_format_prefix_mixed_subschemas) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "type": "object",
    "properties": {
...
TEST(AlterSchema_lint_draft4, pattern_properties_non_ecma_regex_valid_simple) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "title": "Test",
    "description": "A test schema",
...
TEST(AlterSchema_lint_draft4, pattern_properties_non_ecma_regex_posix_class) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "title": "Test",
    "description": "A test schema",
...
TEST(AlterSchema_lint_draft4, pattern_properties_non_ecma_regex_nested) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "title": "Test",
    "description": "A test schema",
...
TEST(AlterSchema_lint_draft4, pattern_properties_non_ecma_regex_mixed_keys) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-04/schema#",
    "title": "Test",
    "description": "A test schema",
