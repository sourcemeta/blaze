...
TEST_F(CanonicalizerDraft6Test, incoherent_exclusive_limits_3) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "exclusiveMinimum": 5,
    "exclusiveMaximum": 2,
...
TEST_F(CanonicalizerDraft6Test, incoherent_exclusive_limits_4) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "properties": {
      "main": { "$ref": "#/definitions/test/additionalProperties" }
    },
    "definitions": {
      "test": {
        "type": "object",
...
TEST_F(CanonicalizerDraft6Test, incoherent_exclusive_limits_5) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "type": "number",
    "exclusiveMinimum": 5,
...
TEST_F(CanonicalizerDraft6Test, incoherent_exclusive_limits_6) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "type": "integer",
    "exclusiveMinimum": 5,
...
TEST_F(CanonicalizerDraft6Test, incoherent_exclusive_limits_7) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "type": ["string", "number"],
    "exclusiveMinimum": 5,
...
TEST_F(CanonicalizerDraft6Test, incoherent_exclusive_limits_8) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "allOf": [ { "type": "string" } ],
    "exclusiveMinimum": 5,
