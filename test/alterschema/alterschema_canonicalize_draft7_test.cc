...
TEST_F(CanonicalizerDraft7Test, unsatisfiable_duplicate_oneof_branches_2) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-07/schema#",
    "oneOf": [
      { "type": "string" },
...
TEST_F(CanonicalizerDraft7Test, unsatisfiable_duplicate_oneof_branches_3) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-07/schema#",
    "oneOf": [
      { "type": "string" },
...
TEST_F(CanonicalizerDraft7Test, if_then_else_with_allof_sibling) {
  ...
  const auto expected = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-07/schema#",
    "allOf": [
      { "allOf": [ { "type": "integer", "multipleOf": 1, "minimum": 0 } ] },
      {
        "if": { "type": "integer", "multipleOf": 1, "minimum": 10 },
