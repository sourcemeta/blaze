...
TEST(unknown_format_prefix_recognized) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    ...
    "properties": {
      ...
      "b": { "type": "string", "format": "uri-template" },
      "c": { "type": "string", "format": "json-pointer" },
...
TEST(unknown_format_prefix_demote_date) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "type": "string",
    "format": "date"
...
TEST(unknown_format_prefix_demote_time) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "type": "string",
    "format": "time"
...
TEST(unknown_format_prefix_demote_regex) {
  sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "type": "string",
    "format": "regex"
...
TEST(AlterSchema_lint_draft6, disjunctor_min_branches_1) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "title": "My Schema",
...
TEST(AlterSchema_lint_draft6, disjunctor_min_branches_2) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "title": "My Schema",
    "description": "A schema",
...
TEST(AlterSchema_lint_draft6, disjunctor_min_branches_3) {
  const sourcemeta::core::JSON document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "http://json-schema.org/draft-06/schema#",
    "title": "My Schema",
    "description": "A schema",
