...
TEST(unevaluated_properties_single_ref_to_additional_properties_2020_12) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "type": "object",
    "allOf": [ { "$ref": "#/$defs/base" } ],
...
TEST(unevaluated_properties_single_ref_target_with_anyof_stays_2020_12) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "type": "object",
    "allOf": [ { "$ref": "#/$defs/base" } ],
...
TEST(
    unevaluated_properties_single_ref_target_with_additional_properties_stays_2020_12) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "type": "object",
    "allOf": [ { "$ref": "#/$defs/base" } ],
...
TEST(
    unevaluated_properties_single_ref_target_with_uncovered_required_stays_2020_12) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "type": "object",
    "allOf": [ { "$ref": "#/$defs/base" } ],
...
TEST(
    unevaluated_properties_single_ref_target_with_pattern_properties_stays_2020_12) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "type": "object",
    "allOf": [ { "$ref": "#/$defs/base" } ],
...
TEST(unevaluated_properties_single_ref_target_with_if_then_stays_2020_12) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "type": "object",
    "allOf": [ { "$ref": "#/$defs/base" } ],
...
TEST(unevaluated_properties_multi_ref_to_additional_properties_2020_12) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "type": "object",
...
TEST(
    unevaluated_properties_multi_ref_one_target_with_pattern_properties_stays_2020_12) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "type": "object",
...
TEST(unevaluated_properties_multi_ref_non_ref_branch_stays_2020_12) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "type": "object",
...
TEST(
    unevaluated_properties_single_ref_sibling_unevaluated_items_converts_2020_12) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "type": "object",
    "allOf": [ { "$ref": "#/$defs/base" } ],
...
TEST(
    unevaluated_properties_single_ref_target_unevaluated_items_converts_2020_12) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "type": "object",
    "allOf": [ { "$ref": "#/$defs/base" } ],
...
TEST(unevaluated_properties_with_properties_sibling_2020_12) {
  auto document = sourcemeta::core::parse_json(R"JSON({
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "type": "object",
