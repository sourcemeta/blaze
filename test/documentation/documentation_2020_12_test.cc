...
TEST_F(Documentation202012Test, nested_object_with_default) {
  ...
  const auto expected{sourcemeta::core::parse_json(R"JSON({
    ...
    "rows": [
      ...
      {
        "identifier": 2,
        "path": [ { "type": "literal", "value": "address" } ],
        "type": { "kind": "object" },
        "required": false,
        "constraints": [ ">= 1 properties" ]
      },
      {
        "identifier": 3,
        "path": [
          { "type": "literal", "value": "address" },
          { "type": "literal", "value": "street" }
        ],
        "type": { "kind": "primitive", "name": "string" },
        "required": true
      },
    ...
    "rows": [
      {
        ...
        "path": [ { "type": "synthetic", "value": "root" } ],
        "type": { "kind": "object" },
        "constraints": [ ">= 1 properties", "<= 5 properties" ]
      }
    ]
  })JSON")};
...
TEST_F(Documentation202012Test, property_write_only) {
  ...
  const auto expected{sourcemeta::core::parse_json(R"JSON({
    ...
    "rows": [
      ...
      {
        "identifier": 2,
        "path": [ { "type": "literal", "value": "password" } ],
        "modifiers": [ "writeOnly" ],
        "type": { "kind": "primitive", "name": "string" },
        "required": false
      }
    ...
    "rows": [
      {
        ...
        "path": [ { "type": "synthetic", "value": "root" } ],
        "type": { "kind": "object" },
        "constraints": [ "keys >= 1 chars", "keys <= 50 chars" ]
      }
    ]
  })JSON")};
...
TEST_F(Documentation202012Test, property_name_with_slash) {
  ...
  const auto expected{sourcemeta::core::parse_json(R"JSON({
    ...
    "rows": [
      ...
      {
        "identifier": 2,
        "path": [ { "type": "literal", "value": "foo/bar" } ],
        "type": { "kind": "primitive", "name": "string" },
        "required": false
      }
    ]
...
TEST_F(Documentation202012Test, property_boolean_true) {
  ...
  const auto expected{sourcemeta::core::parse_json(R"JSON({
    ...
    "rows": [
      ...
      {
        "identifier": 2,
        "path": [ { "type": "literal", "value": "anything" } ],
        "type": { "kind": "any" },
        "required": false
      }
    ]
...
TEST_F(Documentation202012Test, property_boolean_false) {
  ...
  const auto expected{sourcemeta::core::parse_json(R"JSON({
    ...
    "rows": [
      ...
      {
        "identifier": 2,
        "path": [ { "type": "literal", "value": "impossible" } ],
        "type": { "kind": "never" },
        "required": false
      }
    ]
...
TEST_F(Documentation202012Test, internal_ref_non_recursive) {
  ...
  const auto expected{sourcemeta::core::parse_json(R"JSON({
    ...
    "rows": [
      ...
      {
        "identifier": 2,
        "path": [ { "type": "literal", "value": "billing" } ],
        "type": { "kind": "object" },
        "required": false,
        "constraints": [ ">= 1 properties" ]
      },
      ...
      {
        "identifier": 5,
        "path": [ { "type": "literal", "value": "shipping" } ],
        "type": { "kind": "object" },
        "required": false,
        "constraints": [ ">= 1 properties" ]
      },
...
TEST_F(Documentation202012Test, internal_ref_shared_def_with_recursion) {
  ...
  const auto expected{sourcemeta::core::parse_json(R"JSON({
    ...
    "rows": [
      ...
      {
        "identifier": 2,
        "path": [ { "type": "literal", "value": "primary" } ],
        "type": { "kind": "object" },
        "required": false
      },
      {
      ...
      },
      {
        ...
        "path": [
          { "type": "literal", "value": "primary" },
          { "type": "literal", "value": "backup" }
        ],
        "type": { "kind": "recursiveRef", "identifier": 2 },
        "required": false
      },
      {
        "identifier": 5,
        "path": [ { "type": "literal", "value": "emergency" } ],
        "type": { "kind": "object" },
        "required": false
      },
      {
      ...
      },
      {
        ...
        "type": { "kind": "recursiveRef", "identifier": 5 },
        "required": false
      }
    ]
  })JSON")};
                    ...
                    "rows": [
                      {
                        ...
                        "type": { "kind": "any" },
                        "constraints": [ "must NOT match >= 1 properties" ]
                      }
                    ]
                  },
                  {
