#ifndef SOURCEMETA_BLAZE_CANONICALIZER_TRANSFORMER_H_
#define SOURCEMETA_BLAZE_CANONICALIZER_TRANSFORMER_H_
...
class SOURCEMETA_BLAZE_CANONICALIZER_EXPORT SchemaTransformRule {
public:
...
class SOURCEMETA_BLAZE_CANONICALIZER_EXPORT SchemaTransformer {
public:
