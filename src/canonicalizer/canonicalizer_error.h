...
class SOURCEMETA_BLAZE_CANONICALIZER_EXPORT SchemaRuleMissingNameError
...
class SOURCEMETA_BLAZE_CANONICALIZER_EXPORT SchemaRuleInvalidNameError
    : public std::exception {
public:
...
class SOURCEMETA_BLAZE_CANONICALIZER_EXPORT SchemaRuleInvalidNamePatternError
    : public std::exception {
public:
