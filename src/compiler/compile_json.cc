...
#define HANDLE_STEP(category, type, name)                                      \
  ...
  HANDLE_STEP("assertion", "type-string-upper", AssertionTypeStringUpper)
  HANDLE_STEP("assertion", "type-array-bounded", AssertionTypeArrayBounded)
  HANDLE_STEP("assertion", "type-array-upper", AssertionTypeArrayUpper)
  HANDLE_STEP("assertion", "type-object-bounded", AssertionTypeObjectBounded)
  HANDLE_STEP("assertion", "type-object-upper", AssertionTypeObjectUpper)
  ...
  HANDLE_STEP("loop", "properties-match-closed", LoopPropertiesMatchClosed)
  ...
  HANDLE_STEP("loop", "properties-regex-closed", LoopPropertiesRegexClosed)
