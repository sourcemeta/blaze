...
evaluate_instruction(const sourcemeta::blaze::Instruction &instruction,
  ...
  // Fast-path for trivial instructions to avoid indirect call overhead.
  // Only a few cases are inlined here to avoid bloating this function
  // and hurting icache locality.
