if(NOT BoostRegex_FOUND)
  ...
  add_library(boost_regex INTERFACE
    "${BOOST_REGEX_PUBLIC_HEADER}" ${BOOST_REGEX_PRIVATE_HEADERS})
  ...
  if(BLAZE_INSTALL)
    ...
    install(TARGETS boost_regex
      EXPORT boost_regex
      PUBLIC_HEADER DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}/boost/regex"
        COMPONENT sourcemeta_blaze_dev
      PRIVATE_HEADER DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}/boost/regex"
        COMPONENT sourcemeta_blaze_dev
      RUNTIME DESTINATION "${CMAKE_INSTALL_BINDIR}"
        COMPONENT sourcemeta_blaze
      LIBRARY DESTINATION "${CMAKE_INSTALL_LIBDIR}"
        COMPONENT sourcemeta_blaze
        NAMELINK_COMPONENT sourcemeta_blaze_dev
      ARCHIVE DESTINATION "${CMAKE_INSTALL_LIBDIR}"
        COMPONENT sourcemeta_blaze_dev)
    install(EXPORT boost_regex
      DESTINATION "${CMAKE_INSTALL_LIBDIR}/cmake/boost/regex"
      COMPONENT sourcemeta_blaze_dev)

    # file(WRITE ${CMAKE_CURRENT_BINARY_DIR}/boost_regex-config.cmake
      # "include(\"\${CMAKE_CURRENT_LIST_DIR}/boost_regex.cmake\")\n"
      # "check_required_components(\"boost_regex\")\n")
    # install(FILES
      # "${CMAKE_CURRENT_BINARY_DIR}/boost_regex-config.cmake"
      # DESTINATION "${CMAKE_INSTALL_LIBDIR}/cmake/boost_regex"
      # COMPONENT sourcemeta_blaze_dev)
  endif()
